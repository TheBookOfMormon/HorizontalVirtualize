...
function findClosestScrollContainer(element, horizontal) {
...
function init(dotNetHelper, spacerBefore, spacerAfter, horizontal, rootMargin = 50) {
    ...
    function intersectionCallback(entries, horizontal) {
    ...
    function getTableDisplay(horizontal) {
...
function getObserversMapEntry(dotNetHelper) {
    ...
    dotNetHelperDispatcher[dispatcherObserversByDotNetIdPropname] ?? (dotNetHelperDispatcher[dispatcherObserversByDotNetIdPropname] = {});
    return {
